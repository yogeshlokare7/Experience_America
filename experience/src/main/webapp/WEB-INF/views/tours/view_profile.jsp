...
<tiles:insertDefinition name="defaultTemplate">
	<tiles:putAttribute name="body">
		...
		<div class="x_content">
			<table id="datatable" class="table table-striped table-bordered">
				...
				<c:forEach items="${homestay}" var="homestay">
					<tr>
						...
						<td>${homestay.propertytype}</td>
						<td>${homestay.guestno}</td>
			...
			<div>
				<button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg">Create Tour Profile</button>
			</div>
		</div>
